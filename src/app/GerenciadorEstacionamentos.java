...
public class GerenciadorEstacionamentos {
    ...
    public void cadastrarEstacionamento() {
        ...
        LocalTime inicioNoturno = LocalTime.parse(JOptionPane.showInputDialog(null,"Insira o horário de início do período noturno do estacionamento:"));
        LocalTime inicioDiurno = LocalTime.parse(JOptionPane.showInputDialog(null,"Insira o horário de início do período diurno do estacionamento:"));
        LocalTime horarioAbertura = LocalTime.parse(JOptionPane.showInputDialog(null, "Insira o horário de abertura do estacionamento:"));
        LocalTime horarioFechamento = LocalTime.parse(JOptionPane.showInputDialog(null, "Insira o horário de fechamento do estacionamento:"));
